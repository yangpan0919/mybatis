...
public class TestUtils {
    ...
    public static void testEntityWrapperDelete() {
    ...
    public static void testEntityWrapperUpdate() {
     ...
     * 条件构造器   查询操作
     */
    public static void testEntityWrapperSelect() {
...
//		System.out.println(emps);
     ...
     * 通用 删除操作
     */
    public static  void testCommonDelete() {
        //1 .根据id进行删除
...
//		System.out.println("result: " + result );
    ...
    public static void  testCommonSelect() {
        //1. 通过id查询
...
//		System.out.println(emps);
    ...
    public static void testCommonInsert() {
